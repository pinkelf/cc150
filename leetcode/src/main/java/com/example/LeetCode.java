...
public class LeetCode {
    public static void main(String... args) {
        ...
        System.out.println("34. search for a range " + com.example.pack1to50.SearchForARange.searchRange(new int[]{1, 2, 3, 4, 5, 5, 5, 8, 9}, 5));

        //35 SearchInsertPosition
        System.out.println("35. seach insert position " + com.example.pack1to50.SearchInsertPosition.searchInsert(new int[]{1, 2, 5, 8, 10}, 6));
